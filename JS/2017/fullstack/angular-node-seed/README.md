# MO: This is an angular node mongo SEED folder structure from:
https://github.com/DavideViolante/Angular-Full-Stack

# MO: Setup to easily run debug inside vscode. Added proper launch and attch to launch.json Read:
    https://nodejs.org/en/docs/inspector/ in the VS Code 1.10+ section.
